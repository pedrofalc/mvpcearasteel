    ...
    <div id="panel-content">
			...
			<div class="section">
				...
				<form method="post" action="<?php echo admin_url( 'admin.php?page=' . $this->token ); ?>">
					...
					<p><label><input type="radio" name="export-type" value="all"<?php checked( 'all', $export_type ); ?>> <?php _e( 'All Settings', 'colabsthemes' ); ?> (<em><?php _e( 'This will contain all of the options listed below.', 'colabsthemes' ); ?></em>)</label></p>
...
<?php
	...
	function admin_screen_help ( $contextual_help, $screen_id, $screen ) {
		...
		$contextual_help =
		  ...
		  '<p>' . sprintf( __( 'Please post your query on the %sColorlabs Support Forums%s where we will do our best to assist you further.', 'colabsthemes' ), '<a href="http://colorlabsproject.com/resolve/" target="_blank">', '</a>' ) . '</p>';
