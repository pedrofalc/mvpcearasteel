...
function colabs_shortcode_twitter($atts, $content = null) {
	...
	$output = '<div class="colabs-sc-twitter '.$float.'"><a href="http://twitter.com/share" class="twitter-share-button"'.$output.' data-count="'.$style.'">Tweet</a></div>';
...
function colabs_shortcode_digg($atts, $content = null) {
  ...
  $link = ' href="http://digg.com/submit?url='.urlencode( $link ).$title.'"';
	...
	$output .= '<div class="colabs-digg '.$float.'"><a class="DiggThisButton Digg'.$style.'" '.$link.'>'.__('Share Digg','colabsthemes').'</a></div>';
	return $output;
...
function colabs_shortcode_fblike($atts, $content = null) {
  ...
  $output .= '<div class="fb-like colabs-fblike '.$float.'" 
        data-href="'.$url.'" 
        data-width="'.$width.'"
        data-layout="'.$style.'" 
        data-action="'.$verb.'" 
  ...
  add_action('wp_footer','colabs_facebook_like_script');  
	return $output;

}
add_shortcode( 'fblike', 'colabs_shortcode_fblike' );

function colabs_facebook_like_script(){
  ?>
...
function colabs_shortcode_twocol_one_last($atts, $content = null) {
   return '<div class="twocol-one last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_threecol_one_last($atts, $content = null) {
   return '<div class="threecol-one last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_threecol_two_last($atts, $content = null) {
   return '<div class="threecol-two last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fourcol_one_last($atts, $content = null) {
   return '<div class="fourcol-one last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fourcol_two_last($atts, $content = null) {
   return '<div class="fourcol-two last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fourcol_three_last($atts, $content = null) {
   return '<div class="fourcol-three last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fivecol_one_last($atts, $content = null) {
   return '<div class="fivecol-one last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fivecol_two_last($atts, $content = null) {
   return '<div class="fivecol-two last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fivecol_three_last($atts, $content = null) {
   return '<div class="fivecol-three last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fivecol_four_last($atts, $content = null) {
   return '<div class="fivecol-four last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_sixcol_one_last($atts, $content = null) {
   return '<div class="sixcol-one last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_sixcol_two_last($atts, $content = null) {
   return '<div class="sixcol-two last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_sixcol_three_last($atts, $content = null) {
   return '<div class="sixcol-three last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_sixcol_four_last($atts, $content = null) {
   return '<div class="sixcol-four last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_sixcol_five_last($atts, $content = null) {
   return '<div class="sixcol-five last">' . colabs_remove_wpautop($content) . '</div><div class="clear"></div>';
}
...
function colabs_shortcode_fbshare($atts, $content = null) {
  ...
  $output = '<div class="colabs-fbshare ' . $float . '"><div class="fb-share-button" data-href="' . $url . '" data-layout="' . $type . '"></div></div>';
  add_action('wp_footer','colabs_facebook_like_script');
	return $output;
...
function colabs_shortcode_twitter_follow ( $atts, $content = null ) {
  ...
  $output = '<div class="shortcode-twitter-follow' . $allowed_floats[$float] . '">';
  $output .= '<a href="https://twitter.com/'.$username.'" class="twitter-follow-button" ' . $tag_atts . '>Follow @'.$username.'</a>';
  $output .= '</div>';
