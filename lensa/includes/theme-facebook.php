...
{	
	...
	function register_facebook_admin_head(){
			...
			echo '<link rel="stylesheet" type="text/css" href="' . get_template_directory_uri() . '/functions/css/admin-style.css" media="screen" />';
	...
	function colabs_facebook_admin_page()
	{
		global $colabs_facebook_name;
			...
			?>
			<div id="colabs_options" class="wrap <?php if (is_rtl()) { echo 'rtl'; } ?> colabs_facebook">
