...
<h3 class="panel-title module-item-title"><?php echo $page_title; ?></h3>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
  ...
  <div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
    <header class="title clearfix">
      ...
      <a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit btn btn-red btn-mini btn-uppercase btn-full-color btn-bold float-left"><?php _e( 'Edit', 'woocommerce' ); ?></a>
    </header>
    <address>
      <?php
